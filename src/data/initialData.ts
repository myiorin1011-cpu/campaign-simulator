...
const baseData: Omit<AppData, 'purchasePlans1' | 'purchasePlans2' | 'performerRanks1' | 'performerRanks2'> = {
  ...
  performerRanks: [
    ...
    { stage:2,  name:'シルバー',          nameEn:'Silver',         actions: defaultActions([120,80,20],[6,4,1],[495,330,110],[750,500,160],[225,150,55],[375,250,80],[120,80,25],[600,400,130],[0,0,0],[0,0,0],[0,0,0],[150,100,30],[495,330,110],[750,500,160]) },
    { stage:3,  name:'ゴールド',          nameEn:'Gold',           actions: defaultActions([150,100,30],[9,6,2],[600,400,125],[900,600,200],[300,200,65],[450,300,100],[180,120,38],[750,500,165],[0,0,0],[0,0,0],[0,0,0],[150,100,30],[600,400,125],[900,600,200]) },
    { stage:4,  name:'プラチナ',          nameEn:'Platinum',       actions: defaultActions([180,120,40],[12,8,2],[720,480,160],[1095,730,240],[360,240,80],[540,360,120],[195,130,41],[900,600,200],[0,0,0],[0,0,0],[0,0,0],[150,100,30],[720,480,160],[1095,730,240]) },
    { stage:5,  name:'サファイア',        nameEn:'Sapphire',       actions: defaultActions([225,150,50],[15,10,3],[840,560,180],[1245,830,275],[420,280,90],[630,420,140],[225,150,48],[1050,700,230],[0,0,0],[0,0,0],[0,0,0],[150,100,30],[840,560,180],[1245,830,275]) },
    { stage:6,  name:'エメラルド',        nameEn:'Emerald',        actions: defaultActions([270,180,60],[18,12,4],[960,640,200],[1440,960,320],[480,320,105],[720,480,160],[270,180,58],[1200,800,265],[0,0,0],[0,0,0],[0,0,0],[150,100,30],[960,640,200],[1440,960,320]) },
    ...
    { stage:8,  name:'ルビー',            nameEn:'Ruby',           actions: defaultActions([300,200,70],[21,14,4],[1320,880,295],[1995,1330,440],[660,440,145],[990,660,220],[315,210,68],[1500,1000,330],[0,0,0],[0,0,0],[0,0,0],[150,100,30],[1320,880,295],[1995,1330,440]) },
    ...
    { stage:10, name:'ダイヤモンド',      nameEn:'Diamond',        actions: defaultActions([375,250,90],[24,16,5],[1680,1120,380],[2490,1660,560],[840,560,185],[1260,840,280],[375,250,83],[1800,1200,400],[0,0,0],[0,0,0],[0,0,0],[150,100,30],[1680,1120,380],[2498,1665,560]) },
    { stage:11, name:'ロイヤルダイヤモンド',nameEn:'Royal Diamond', actions: defaultActions([450,300,110],[27,18,6],[1920,1280,470],[2895,1930,640],[960,640,210],[1440,960,320],[435,290,99],[1950,1300,430],[0,0,0],[0,0,0],[0,0,0],[150,100,30],[1920,1280,470],[2895,1930,640]) },
    { stage:12, name:'シュプリーム',      nameEn:'Supreme',        actions: defaultActions([525,350,140],[33,22,7],[2250,1500,550],[3300,2200,730],[1095,730,240],[1650,1100,385],[495,330,112],[2250,1500,500],[0,0,0],[0,0,0],[0,0,0],[150,100,30],[2250,1500,550],[3300,2200,730]) },
  ],
