...
export const seedCampaigns: Campaign[] = [
  c('記念', 'Canowリリースキャンペーン！運命の初鑑定SP', 31, '7/1(水)', '7/31(金)', 'A1', '1通, 1文字', '準備中'),
  c('ボーナス', 'リリースCP同時開催！Storeや広告ページにプロフ写真の掲載チャンス！', 92, '7/1(水)', '9/30(水)', 'E', '', '準備中', '対応なし', '対応なし', '対応なし'),
  c('季節', '夏の運命、全部見せます — 真夏の占いFEST', 31, '8/1(日)', '8/31(月)', 'B3', '', '準備中'),
  c('季節', '満月の夜。あなたの運命が照らされる 中秋の名月CP', 30, '9/1(水)', '9/30(水)', 'B3', '', '準備中'),
  c('季節', '秘密の恋、見抜かれる夜 — ハロウィン占い祭', 31, '10/1(金)', '10/31(日)'),
  c('季節', '年に一度だけ。ポイント超増量 BLACK FRIDAYキャンペーン', 30, '11/1(月)', '11/30(火)'),
  c('季節', '奇跡の季節に、運命も動く —クリスマス&歳末感謝祭', 31, '12/1(水)', '12/31(金)'),
  c('季節', '今年の運命、先取りしよう — 新春初鑑定キャンペーン', 17, '1/1(金)', '1/17(日)'),
  c('季節', 'あの人の本音、今だけ見えます —バレンタイン恋愛占いキャンペーン', 14, '2/1(月)', '2/14(日)'),
  c('季節', '返事を待つより、先に知ろう —ホワイトデー恋愛占いCP', 14, '3/1(月)', '3/14(日)'),
  c('季節', '新しい私へ。桜と一緒に運命が開く サクラサク新生活CP', 30, '3/19(金)', '4/18(日)'),
  c('季節', '連休まるごと、ガッツリ占ってもらうなら今 GW集中鑑定キャンペーン', 18, '4/23(金)', '5/9(日)'),
  c('季節', '運命の人を引き寄せる6月 —ジューンブライド 縁結びCP', 30, '6/1(火)', '6/30(水)'),
  c('季節', '願いを星に届ける夜 七夕 縁結び占いCP', 10, '7/1(木)', '7/11(日)'),
