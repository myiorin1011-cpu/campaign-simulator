...
const c = (
  ...
  id: `seed-c-${++cid}`, category, title, durationDays, start, end, pattern, tag, status, ptDesign, banner, ptSetting,
})

export const seedCampaigns: Campaign[] = [
  c('記念', 'Canowリリースキャンペーン！運命の初鑑定SP', 31, '2026-07-01', '2026-07-31', 'A1', '1通, 1文字', '準備中'),
  c('ボーナス', 'リリースCP同時開催！Storeや広告ページにプロフ写真の掲載チャンス！', 92, '2026-07-01', '2026-09-30', 'E', '', '準備中', '対応なし', '対応なし', '対応なし'),
  c('季節', '夏の運命、全部見せます — 真夏の占いFEST', 31, '2026-08-01', '2026-08-31', 'B3', '', '準備中'),
  c('季節', '満月の夜。あなたの運命が照らされる 中秋の名月CP', 30, '2026-09-01', '2026-09-30', 'B3', '', '準備中'),
  c('季節', '秘密の恋、見抜かれる夜 — ハロウィン占い祭', 31, '2026-10-01', '2026-10-31'),
  c('季節', '年に一度だけ。ポイント超増量 BLACK FRIDAYキャンペーン', 30, '2026-11-01', '2026-11-30'),
  c('季節', '奇跡の季節に、運命も動く —クリスマス&歳末感謝祭', 31, '2026-12-01', '2026-12-31'),
  c('季節', '今年の運命、先取りしよう — 新春初鑑定キャンペーン', 17, '2027-01-01', '2027-01-17'),
  c('季節', 'あの人の本音、今だけ見えます —バレンタイン恋愛占いキャンペーン', 14, '2027-02-01', '2027-02-14'),
  c('季節', '返事を待つより、先に知ろう —ホワイトデー恋愛占いCP', 14, '2027-03-01', '2027-03-14'),
  c('季節', '新しい私へ。桜と一緒に運命が開く サクラサク新生活CP', 30, '2027-03-19', '2027-04-18'),
  c('季節', '連休まるごと、ガッツリ占ってもらうなら今 GW集中鑑定キャンペーン', 18, '2027-04-23', '2027-05-09'),
  c('季節', '運命の人を引き寄せる6月 —ジューンブライド 縁結びCP', 30, '2027-06-01', '2027-06-30'),
  c('季節', '願いを星に届ける夜 七夕 縁結び占いCP', 10, '2027-07-01', '2027-07-11'),
  c('記念', 'Canow ○周年！ありがとうの大還元祭', 31, '', ''),
  c('記念', '○万人突破！みんなで祝う大感謝祭', 31, '', ''),
  c('ボーナス', 'フォローするだけで運気UP — 今すぐGETしよう', 30, '', ''),
  c('定期', '新規占い師 初月単価UPボーナス', 0, '', ''),
  c('定期', 'ランクUP達成ボーナス', 0, '', ''),
  c('定期', '月間売上達成 報酬率UPボーナス', 0, '', ''),
  c('定期', 'プロフィール・画像投稿ボーナス', 0, '', ''),
  c('定期', 'ランキング入賞ボーナス', 0, '', ''),
  c('ゲリラ', '今夜だけ。満月パワーでポイントが急増中', 1, '', ''),
  c('ゲリラ', '大安の日だけ。今日がいちばんお得な日 ポイント増量ゲリライベント開催中', 1, '', ''),
  c('ゲリラ', '一粒万倍日。今日の投資が何倍にもなる ポイント増量ゲリライベント開催中', 1, '', ''),
]
