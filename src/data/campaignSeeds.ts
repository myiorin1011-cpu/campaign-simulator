...
const userCampaigns: Campaign[] = [
  ...
  u('季節', '夏の運命、全部見せます — 真夏の占いFEST', 39, '2027-07-23', '2027-08-31'),
  u('季節', '満月の夜。あなたの運命が照らされる 中秋の名月CP', 30, '2027-09-01', '2027-09-30'),
  u('季節', '秘密の恋、見抜かれる夜 — ハロウィン占い祭', 31, '2027-10-01', '2027-10-31'),
  u('季節', '年に一度だけ。ポイント超増量 BLACK FRIDAYキャンペーン', 30, '2027-11-01', '2027-11-30'),
  u('季節', '奇跡の季節に、運命も動く —クリスマス&歳末感謝祭', 31, '2027-12-01', '2027-12-31'),
